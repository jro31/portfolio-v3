...
// NICETOHAVE - Currently any programatic scrolling (between sections, the tools icons, and the projects) is not smooth on Safari. Find a fix. - Note, allegedly fixed in Safari 12.4. Yet to test.
