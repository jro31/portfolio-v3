const CodingIcon = props => {
  return (
    <svg viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'>
      <g>
        <rect className='fill-transparent' height='60' width='60' />
        <circle className={`fill-${props.colorClass}` || 'fill-black'} cx='9.33' cy='15.74' r='1' />
        <circle className={`fill-${props.colorClass}` || 'fill-black'} cx='16' cy='15.74' r='1' />
        <circle
          className={`fill-${props.colorClass}` || 'fill-black'}
          cx='12.67'
          cy='15.74'
          r='1'
        />
